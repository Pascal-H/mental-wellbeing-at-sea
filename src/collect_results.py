...
if __name__ == "__main__":
    ...
    # Original: dataset_name = "mwas"
    dataset_name = "synthetic"  # For pipeline verification with synthetic data
    ...
    if not all_targets:
        ...
        print(f"Fallback: just evaluating {all_targets}")
    # Original single-target setting:
    # cur_target = "who_5_percentage_score_corrected"
    ...
    search_term = {"term": None, "name": "everything"}
    # search_term = {
